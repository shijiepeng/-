    ...
    <div className="min-h-screen bg-[#f7f4f2]">
      ...
      <main className="px-4 pb-24" key={currentQuestion}>
              ...
              {[...Array(11)].map((_, i) => (
                <button
                  ...
                  className={`w-12 h-12 rounded-lg font-semibold text-lg transition-all ${
                    scaleValue === i
                      ? "bg-[#B5CF80] text-[#4b3425] scale-110"
        ...
        <button
          ...
          className="fixed bottom-8 left-4 right-4 bg-[#B5CF80] text-[#4b3425] py-4 rounded-full font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed"
        >
